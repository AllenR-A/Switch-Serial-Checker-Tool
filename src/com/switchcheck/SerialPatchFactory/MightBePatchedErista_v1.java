...
/**
 * This is the "Might-be-patched" Erista (v1) object
 * @author Allen Royce Aleta
 */
public class MightBePatchedErista_v1 implements SwitchFactoryInterface {
    public String inform(){
        return """
                
                Erista (v1) - Might be Patched...
                =========================================================================================================
                ...
                (the reason for this is 'cause the patched units were first silently produced & released
                around the same time that the unpatched switches were still being produced, so no one knows
                for sure which is which around this timeframe)
                =========================================================================================================
